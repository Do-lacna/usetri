...
export const addToCart = (
  ...
  return orvalApiClient<AddToCartResponse>(
    {
      url: `/carts`,
      method: 'PUT',
...
export const getAddToCartMutationOptions = <
  TData = Awaited<ReturnType<typeof addToCart>>,
...
export type AddToCartMutationError = ProblemDetails;
...
>(options?: {
  ...
  >;
  request?: SecondParameter<typeof orvalApiClient>;
}): UseMutationResult<TData, TError, { data: AddToCartRequest }, TContext> => {
...
export const getDeleteCartMutationOptions = <
  TData = Awaited<ReturnType<typeof deleteCart>>,
  TError = ProblemDetails,
  TContext = unknown,
>(options?: {
...
export type DeleteCartMutationError = ProblemDetails;
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetCartComparisonQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCartComparison>>
  > = ({ signal }) => getCartComparison(requestOptions, signal);
...
>(options?: {
  ...
  const queryOptions = getGetCartComparisonQueryOptions(options);
