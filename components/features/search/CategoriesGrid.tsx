  ...
  return (
    <View className="flex-1">
      <View className="mt-6 mb-4 px-4 flex-row justify-between items-center">
        <Text className="text-2xl font-bold text-foreground">{t('categories_title')}</Text>
        {!isLoading && (
          <Text className="text-sm text-muted-foreground">{t('categories_count', { count: filteredCategories.length })}</Text>
        )}
      </View>
